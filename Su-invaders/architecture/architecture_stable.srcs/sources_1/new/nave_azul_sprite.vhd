...
entity nave_azul_sprite is Port(
    ...
    end nave_azul_sprite;

architecture Behavioral of nave_azul_sprite is
...
constant o_height: integer := 30;
-- addss
constant Ax1: std_logic_vector(11 downto 0) := "000000010010";
constant Ay1: std_logic_vector(11 downto 0) := "000000010011";
constant Ax2: std_logic_vector(11 downto 0) := "000000010100";
constant Ay2: std_logic_vector(11 downto 0) := "000000010101";
constant Ax3: std_logic_vector(11 downto 0) := "000000010110";
constant Ay3: std_logic_vector(11 downto 0) := "000000010111";
constant Ax4: std_logic_vector(11 downto 0) := "000000011000";
constant Ay4: std_logic_vector(11 downto 0) := "000000011001";
constant Ax5: std_logic_vector(11 downto 0) := "000000011010";
constant Ay5: std_logic_vector(11 downto 0) := "000000011011";
-- regs""
...
signal inter_read_address: std_logic_vector(9 downto 0) := (others => '0');
...
component nave_azul_rom is Port(
    clock: in std_logic;
...
block_pixels: nave_azul_rom port map(
    clock=>clock,
...
deteccion_color: process (clock) begin
    if rising_edge(clock) then
        ...
        (current_y >= y1) and (current_y < y1 + o_height) then
            out_in_a_block <= '1';
            inter_read_address <= std_logic_vector(to_unsigned((current_x+4 - x1) + ((current_y - y1) * o_width), 10));
        
        elsif (current_x  >= x2 - 4 ) and (current_x  < x2 + o_width - 4 ) and
        (current_y >= y2) and (current_y < y2 + o_height) then
            out_in_a_block <= '1';
            inter_read_address <= std_logic_vector(to_unsigned((current_x+4 - x2) + ((current_y - y2) * o_width), 10));
        
        elsif (current_x  >= x3 - 4 ) and (current_x  < x3 + o_width - 4 ) and
        (current_y >= y3) and (current_y < y3 + o_height) then
            out_in_a_block <= '1';
            inter_read_address <= std_logic_vector(to_unsigned((current_x+4 - x3) + ((current_y - y3) * o_width), 10));
        
        elsif (current_x  >= x4 - 4 ) and (current_x  < x4 + o_width - 4 ) and
        (current_y >= y4) and (current_y < y4 + o_height) then
            out_in_a_block <= '1';
            inter_read_address <= std_logic_vector(to_unsigned((current_x+4 - x4) + ((current_y - y4) * o_width), 10));
        
        elsif (current_x  >= x5 - 4 ) and (current_x  < x5 + o_width - 4 ) and
        (current_y >= y5) and (current_y < y5 + o_height) then
            out_in_a_block <= '1';
            inter_read_address <= std_logic_vector(to_unsigned((current_x+4 - x5) + ((current_y - y5) * o_width), 10));
        else
            out_in_a_block <= '0';
