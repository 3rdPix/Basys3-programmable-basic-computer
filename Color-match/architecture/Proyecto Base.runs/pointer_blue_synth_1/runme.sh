...
HD_PWD='/home/claudio/U/24.2/arqui/g21/Entrega-3/especial_fase_2_0/Proyecto Base.runs/pointer_blue_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pointer_blue.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pointer_blue.tcl
